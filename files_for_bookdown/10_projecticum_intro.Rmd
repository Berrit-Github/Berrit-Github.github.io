...
bibliography: '`r rbbt::bbt_write_bib("bookdown_gallary/info_projecticum_dsfb2.json", overwrite = TRUE)`'
date: "2023-04-25"
---
# Nutricia project 

In this page I will introduce a short project on which I worked during my data science minor. With this introduction I will show that I have knowledge of Life science searching and writing techniques as well as show I can use rmarkdown as a means to communicate this. In this introduction citations were used through the zotero web extension.
