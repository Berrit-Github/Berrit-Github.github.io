...
![In this picture we combined the flu and dengue data in 1 table to see both searches at the same time](data/dengue_flu_data_combined.PNG)
![In this figure we can see all the colums that are in the gap_data table](data/gap_data.PNG)
...
![In this figure we can see all the colums that are in the gap_data table](data/SQL_join_tables.PNG)
